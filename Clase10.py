...
#%% factor 1 acido
#nivel 1
nivel1=(np.power(df[df['acido']==0]['conductividad'],lambda_opt)-1)/lambda_opt
nivel2=(np.power(df[df['acido']==6]['conductividad'],lambda_opt)-1)/lambda_opt
nivel3=(np.power(df[df['acido']==12]['conductividad'],lambda_opt)-1)/lambda_opt
nivel4=(np.power(df[df['acido']==18]['conductividad'],lambda_opt)-1)/lambda_opt
_, levene_p = stats.levene(nivel1,nivel2,nivel3,nivel4)

print(f"Levene test: p-valor = {levene_p:.4f}")

#%% factor 2 sal
nivel1=(np.power(df[df['sal']==0]['conductividad'],lambda_opt)-1)/lambda_opt
nivel2=(np.power(df[df['sal']==10]['conductividad'],lambda_opt)-1)/lambda_opt
nivel3=(np.power(df[df['sal']==20]['conductividad'],lambda_opt)-1)/lambda_opt
...
nivel1=(np.power(df[df['temperatura']==80]['conductividad'],lambda_opt)-1)/lambda_opt
nivel2=(np.power(df[df['temperatura']==100]['conductividad'],lambda_opt)-1)/lambda_opt
